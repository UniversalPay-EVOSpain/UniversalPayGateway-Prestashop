...
{capture name=path}{l s='Pago con KXPay' mod='kxpay'}{/capture}
{if $action eq 'error'}
    <div class="alert alert-danger">
        {l s='Ocurrio un error al realizar el pago.' mod='kxpay'} <a href="{$link->getPageLink('order', null, null, 'step=3')}">{l s='Volver a la página de pago' mod='kxpay'}</a>
    </div>
{else}
    <div>
