...
class kxpaypaymentModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
		...
		if (Configuration::get('PG_P1C') <> null && $customer->id){
			$params['P1C'] = 'true';
		}
		else
			$params['P1C'] = 'false';
		...
		{
			$ch = curl_init('https://tpvvirtual-test.universalpay.es/client2/token-pro');
			$urlenv = 'https://tpvvirtual-test.universalpay.es/client2/load';
		}
		else
		{
			$ch = curl_init('https://tpvvirtual.universalpay.es/client2/token-pro');
			$urlenv = 'https://tpvvirtual.universalpay.es/client2/load';
		}
